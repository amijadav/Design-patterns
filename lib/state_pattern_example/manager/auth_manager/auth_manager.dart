import 'package:design_patterns/state_pattern_example/manager/auth_manager/auth_manager_impl.dart';
...
abstract class AuthManager {
  ...
  Future<bool> login(String username, String password, [String role = 'user']);
  Future<bool> logout();
}
