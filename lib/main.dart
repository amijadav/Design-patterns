...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      initialRoute: RoutePaths.pageControlButtons.value,
      title: 'Flutter Demo',
      theme: ThemeData(
      ...
      // home: const StatePatternLoginScreen()
      //  const FactoryPatternExample() // const LoginScreen() // MyHomePage(title: 'Flutter Demo Home Page'),
    );
  }
}
